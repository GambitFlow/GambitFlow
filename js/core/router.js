// Router with External Templates
const PAGES = {
    home: null, // Will be loaded from template
    play: null, // Will be loaded from template  
    arena: null, // Will be loaded from template
    models: null,
    docs: null,
    api: null,
    status: null
...
// Load templates
if (typeof PlayPageTemplate !== 'undefined') {
    PAGES.play = PlayPageTemplate;
}

if (typeof ArenaPageTemplate !== 'undefined') {
    PAGES.arena = ArenaPageTemplate;
}

// Home page template (inline for now, can be externalized)
PAGES.home = `
